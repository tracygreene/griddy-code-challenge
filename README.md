...
- grpc-web-service
  - client
     - main.go - calls createData, getData, and deleteData service methods
  - data
    - data.pb.go - code generated by protoc from data.proto
    - data.proto - define services and messages
  - server
    - main.go - implements createData, getData, and deleteData services and creates a server to listen for client
- shared
  - database
    - database.go - database connection
